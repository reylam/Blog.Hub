                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div>
                        ...
                        <trix-editor input="content"
                            class="border-2 border-[#ffd50070] rounded-md w-full py-2 px-3 bg-[#2d3748] text-white placeholder-gray-400 focus:ring-[#FFD600] focus:border-[#FFD600]"></trix-editor>
                    </div>
                    <div>
