<x-app-layout>
    ...
    <section class="flex flex-col gap-6 items-center mb-12 ">
        ...
        <div class="container w-[1380px] h-auto bg-[#b7d5e7] rounded-2xl overflow-hidden relative max-md:h-auto">
    ...
    <div class="flex flex-col gap-9">
        <main class="min-w-full flex flex-col gap-10 items-center justify-center">
            <div class="flex items-start w-[1380px] max-md:w-full max-md:justify-center">
                <p class="font-bold text-3xl">Top Views</p>
            </div>
            <div class="flex w-[1380px] flex-wrap gap-9 max-md:flex-col max-md:w-full max-md:items-center">
